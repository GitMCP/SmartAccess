    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, User_1.User.findOne({ id: id })];
            case 1:
                user = _a.sent();
                if (!user) {
            ...
            case 2: return [4 /*yield*/, User_1.User.find({ where: { deleted_at: null } })];
            case 3:
                users = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.query.id;
                if (!id) {
                    return [2 /*return*/, res.json({ message: 'Please submit an user id' })];
                }
                return [4 /*yield*/, User_1.User.findOne({ id: id })];
            case 1:
                user = _a.sent();
